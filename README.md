...
changed along the way. Putting all together
...
6. Navigate to `http://localhost:8080/swagger-ui.html` in your browser to check everything is working correctly. You can
